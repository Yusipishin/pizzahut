...
Приложение по доставке пиццы **PizzaHut**.

<!-- Дизайн приложения расположен по [ссылке]() -->
...
используется собственный eslint plugin _eslint-plugin-yusipishin_,
...
-   [AuthByTelephone](/src/features/AuthByTelephone)
-   [UserDropdown](/src/features/UserDropdown)
-   [Scrollbar](/src/features/Scrollbar)
